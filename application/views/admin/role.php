                            ...
                            <?php foreach ($role as $r) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url(); ?>Admin/editRole/<?= $r['id']; ?>" class="badge bg-success">edit</a>
                                        <a href="<?= base_url(); ?>Admin/hapusrole/<?= $r['id']; ?>" class="badge badge-danger" onclick="return confirm('Hapus data?');"> Delete </a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
